...
- [2026-07-14 — branch-driven releases and GitHub Pages](2026-07-14-branch-release-pages.md) — exact-SHA CI gating, workflow-owned tags, explicit pip cache paths, immutable release artifacts, exact-ref docs corrections, the ten-minute Pages HTML cache, and `main`/`release/*` policy
- [2026-07-14 — default kernel readiness is separate from runtime service readiness](2026-07-14-default-kernel-readiness.md) — mirror the runtime's resolved `default.kernel-<arch>` selection, guide manual setup, and block Compose before mutation
- [2026-07-14 — stopped runtime XPC outage presentation](2026-07-14-runtime-xpc-outage-presentation.md) — distinguish installed-but-unavailable from binary absence, keep transport text in technical details, and offer a native start action
