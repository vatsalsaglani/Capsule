...
- [2026-07-14 — branch-driven releases and GitHub Pages](2026-07-14-branch-release-pages.md) — exact-SHA CI gating, workflow-owned tags, prerelease-safe bundle versions, explicit pip cache paths, and released-source docs recovery
