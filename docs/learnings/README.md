...
- [2026-07-14 — branch-driven releases and GitHub Pages](2026-07-14-branch-release-pages.md) — exact-SHA CI gating, workflow-owned tags, explicit pip cache paths, immutable release artifacts, exact-ref docs corrections, and `main`/`release/*` Pages policy
