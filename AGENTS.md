...
- [`docs/learnings/2026-07-14-branch-release-pages.md`](docs/learnings/2026-07-14-branch-release-pages.md) — branch-only release UX still requires a workflow-managed Git tag; gate the exact `main` CI SHA, keep full prerelease SemVer outside `CFBundleShortVersionString`, set explicit pip cache paths, and keep the Pages environment open to `main` plus `release/*`
